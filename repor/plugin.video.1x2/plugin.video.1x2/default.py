...
class main():
    ...
    def channels(self):
        result = client.request('http://arenavision.us/guide_x220h1', headers=self.headers)
        ...
        result = result.replace('</tr><tr><td class="auto-style10" colspan="6">Last update:<span class="auto-style15"> <span class="auto-style13">16/07/2019 23:00 CEST</span></span> UTC +1 (Paris, Madrid, Brusells)</td>','')
        result = result.replace('FIFA WOMEN´S WORLD CUP 2019 ','FIFA WOMENS WORLD CUP 2019 ')
        result = result.replace('FIFA WOMEN´S WORLD CUP       ','FIFA WOMENS WORLD CUP')
        result = result.replace('FIFA WOMEN´S WORLD CUP','FIFA WOMENS WORLD CUP')
