...
class main():
    ...
    def channels(self):
        result = client.request('http://arenavision.us/node/117', headers=self.headers)
        ...
        result = result.replace('</tr><tr><td class="auto-style10" colspan="6">Last update:<span class="auto-style15"> <span class="auto-style13">20/07/2019 10:30 CEST</span></span> UTC +1 (Paris, Madrid, Brusells)</td>','')
