...
base_url = "http://bit.ly/2F6sfHU"

base2_url = "http://bit.ly/2W6LCHH"
...
def arenavision_menu():
	...
	try:
		...
		addDir("[B][COLOR red]Agenda/Schedule[/COLOR][/B]", base2_url, 401, os.path.join(current_dir,"icon.png"), 1, True, parser="arenavision-in", parserfunction="arenavision_schedule")
